...
export default function Map({ data }) {
    return (
        <div>
            <MapContainer center={[-33.49541062600386, -70.59621166108582]} zoom={23} scrollWheelZoom={false} zoomControl={false}
                style={{ width: "100%", height: "100%", minHeight: "24rem", zIndex: 30 }}
                className="z-0">
                <TileLayer
                    maxZoom={21}
                    minZoom={18}
